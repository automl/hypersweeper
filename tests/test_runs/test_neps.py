...
#     if Path("./tmp/mlp_neps_asha").exists():
#         shutil.rmtree(Path("./tmp/mlp_neps_asha"))
#     subprocess.call(["python", "examples/mlp.py", "--config-name=mlp_neps_asha", "-m", "hydra.sweeper.n_trials=5"])
#     assert Path("./tmp/mlp_neps_asha").exists(), "Run directory not created"
#     assert Path("./tmp/mlp_neps_asha/runhistory.csv").exists(), "Run history file not created"
#     runhistory = pd.read_csv("./tmp/mlp_neps_asha/runhistory.csv")
...
#     if Path("./tmp/mlp_neps_priorband").exists():
...
#     assert Path("./tmp/mlp_neps_priorband").exists(), "Run directory not created"
#     assert Path("./tmp/mlp_neps_priorband/runhistory.csv").exists(), "Run history file not created"
