...
#     subprocess.call(["python", "examples/mlp.py", "--config-name=mlp_neps_asha", "-m",
#       "hydra.sweeper.n_trials=5", "hydra.run.dir=mlp_neps_asha", "hydra.sweep.dir=mlp_neps_asha"])
...
#     subprocess.call(["python", "examples/mlp.py", "--config-name=mlp_neps_priorband", "-m",
#       "hydra.sweeper.n_trials=5", "hydra.run.dir=mlp_neps_asha", "hydra.sweep.dir=mlp_neps_asha"])
