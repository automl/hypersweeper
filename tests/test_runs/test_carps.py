...
def test_carps_smac_branin_example():
    ...
    subprocess.call(
        [
            "python",
            "examples/branin.py",
            "--config-name=branin_carps_smac",
            "-m",
            "hydra.sweeper.n_trials=5",
            "hydra.run.dir=branin_carps_smac",
            "hydra.sweep.dir=branin_carps_smac",
        ]
    )
...
def test_carps_hebo_branin_example():
    ...
    subprocess.call(
        [
            "python",
            "examples/branin.py",
            "--config-name=branin_carps_hebo",
            "-m",
            "hydra.sweeper.n_trials=5",
            "hydra.run.dir=branin_carps_hebo",
            "hydra.sweep.dir=branin_carps_hebo",
        ]
    )
