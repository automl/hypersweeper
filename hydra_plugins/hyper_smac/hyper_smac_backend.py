...
from hydra_plugins.hyper_smac.hyper_smac_sweeper import HyperSMACSweeper
...
class HyperSMACBackend(HypersweeperBackend):
    """Backend for HyperSMAC."""
    ...
    def __init__(
        ...
        """Initialize the HyperSMAC backend."""
        if sweeper_kwargs is None:
            sweeper_kwargs = {}
        super().__init__(
            opt_class=HyperSMACSweeper,
